...
;(function (root, undefined) {
    ...
    var detect = (root.detect = (function () {
        ...
        _this.parse = function (ua) {
            ...
            var parsers = function (type) {
                return _this.regexes[type + '_parsers'].map(function (obj) {
                    ...
                    function parser(ua) {
                        ...
                        var ret = {}
                        ret.family =
                            (rep ? rep.replace('$1', m[1]) : m[1]) || 'other'
                        ret.major =
                            parseInt(major_rep ? major_rep : m[2]) || null
            ...
            var mobile_os_families = _this.regexes.mobile_os_families.map(
                function (str) {
                    mobile_agents[str] = true
                }
            )
            ...
            a.device.manufacturer =
                a.browser.man || a.os.man || a.device.man || null
            // Cleanup Objects
