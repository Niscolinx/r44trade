                                ...
                                <div className='content'>
                                    <div className='textBlock'>
                                        <p>
                                            ...
                                            for public monitoring. You can view
                                            the complete trading history of
                                            these accounts on third-party
                                            platforms, such as{' '}
                                            <strong>Myfxbook</strong>,{' '}
                                            <strong>FXBlue</strong>,{' '}
                                            <strong>ForexPeaceArmy</strong>,
                                            ...
                                            If you have some know-how of
                                            trading, you must agree to the fact
                                            that it is impossible to have a fake
                                            verified account on these platforms.
                                            Additionally, you can also read the
                                            reviews and experiences, shared by
                                            users/experts/traders/investors on
                                            various famous websites and blogs.
                                        </p>
                                        <p>
                                            For the obvious reasons, we cannot
                                            share the account details of these
                                            trading accounts with any trader or
                                            investor. For doing this, we will
                                            have to change the password for each
                                            of the verified accounts. As we
                                            receive hundreds of queries each and
                                            every day, we might have to repeat
                                            it for the same number of times.
                                            Being an impractical and
                                            time-consuming chore, this practice
                                            is totally avoided for our robot.
                                        </p>
                                    </div>
                                </div>
                            </div>
