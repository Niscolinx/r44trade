 ...
 <div style="position: fixed; z-index: 99999; left: 20px; bottom: 20px;">
    ...
    <div class="bodyWrap">
                    ...
                    <div class="table full">
                        <div class="logoWrap tCell">
                            <div class="logo invisLink">
                                <img src="img/logos.png" alt="logo" height="70px;" />
                                Robot 22 Trade
                                <a href="index.php">main</a>
                            </div>
                        </div>
                        <div class="logReg tCell right">
                            <a href="login.php" class="btnFillColor1Sm">login</a>
                            <a href="register.php" class="btnFillColor2Sm">sign up</a>
                        </div>
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="textBlock">
                        <p style="font-weight: 500; text-shadow: 2px 2px 4px black;">
                            The Fastest Growing cryptocurrency that return dividend from investments to investors <br />
                            and the cryptocurrency that has value in itself.
                        </p>
                    </div>
                    <a href="register.php" class="btnFillGradLg">Get started now</a>
                </div>
                <div class="cfix">
                    <div class="curRate">
                        ...
                        <div class="item">
                            <div class="iconLeft">
                                ...
                                <div class="data">
                                    ...
                                    <span><b><span class="color2">(Accepted)</span></b></span>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                ...
                <div class="headAdv">
                    <ul>
                        <li>
                            <div class="iconLeft">
                                <span class="icon-adv1" style="box-shadow: 2px 2px 3px black;"></span>
                                <span class="data" style="text-shadow: 2px 2px 3px black;">Officially registered
                                    company</span>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="iconLeft">
                                <span class="icon-adv2" style="box-shadow: 2px 2px 3px black;"></span>
                                <span class="data" style="text-shadow: 2px 2px 3px black;">Profitable working
                                    conditions</span>
                            </div>
                        </li>
                    </ul>
                    <p>
                        We strongly believe in performance-based affairs and understand that our very success is tied to
                        the success of our clients. Therefore, we’ve ensured to lace our unique Auto Trading System with
                        all the advanced features that’ll help our clients gain consistent results in the form of higher
                        profit and ROI.
                    </p>
                </div>
            </div>
        ...
        <div>
            ...
            <div class="chart">
                <iframe height="398" width="618"
                    src="https://ssltvc.forexprostools.com/?pair_ID=945629&amp;height=398&amp;width=618&amp;interval=300&amp;plotStyle=area&amp;domain_ID=7&amp;lang_ID=7&amp;timezone_ID=17"></iframe>
            </div>
        </div>
            ...
            <div class="container">
                <div class="cfix">
                    <div class="left">
                        ...
                        <div class="license">
                            <div class="img invisLink" style="background-image: url(img/profile.jpg);"><a
                                    href="img/profile.jpg" target="_blank">license</a></div>

                        </div>
                        <div class="address">
                            <div class="iconLeft">
                                <span class="icon-location gradTxt"></span>
                                <span class="data">71-75 Shelton Street, London, Greater London, United Kingdom, WC2H
                                    9JQ</span>
                            </div>
                        </div>
                    </div>
                    <div class="right">
                        <div class="textBlock">
                            <h3>
                                <b style="color: white;">
                                    WELCOME ON BOARD
                                    JOIN THE TRADE PLATFORM
                                </b>
                            </h3>
                            <br /><br />
                            <p>
                                Robot 22 Trade is the only company dedicated to work on EA, better known as Algo
                                Trading, which atomizes the trading process and brings risk free profit, saves times,
                                money and build better wealth over long period of time.
                                <br /><br />
                                A Robot trading System is used to automatically generate trading signals on the forex
                                trader’s behalf. As such, a manual trader has to glue himself or herself in front of a
                                computer screen and wait for the appropriate time when the criteria for making a
                                decision fits with his or her rules—something which is tiring and complicated.
                                <br /><br />
                                With robot trading, the trading rules or strategies have been ingrained in a computer
                                program, and your trade decisions will be made automatically without your intervention.
                                With a trading robot, you can trade profitably 24 hours a day and increase your profits.
                                After you’ve coded your strategies on a robot, it will perform the buy and sell actions
                                while you spend your time on the beach. One of the main reasons why traders fail is
                                emotional trading. However, a forex robot lowers or eliminates emotions from the trading
                                equation and give you a reliable way of earning money.
                            </p>
                        </div>
                        <div class="btnsWrap">
                            <a href="about.php" class="btnFillColor1Lg">Learn more</a>
                            <a href="https://beta.companieshouse.gov.uk/company/12143668" target="_blank"
                                class="btnFillColor2Lg">Check the registration</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                 <div class="textBlock">
                    <p>
                        ...
                        Some robots can thoroughly and effectively scan the market looking for opportunities with high
                            ...
                            <div class="planCardFirst">
                                <div class="left" style="background-image: url(img/card_bg_1.png);">
                                    ...
                                    <div class="descr">
                                        ...
                                        <span>48 HOURS</span>
                                        <a href="register.php" class="btnFillColor1Md">Make deposit</a>
                                    </div>
                                </div>
                                <ul class="info">
                                    <li>Min Deposit <span>50 USD</span></li>
                                    <li>Max Deposit <span>199 USD</span></li>
                                </ul>
                            ...
                            <div class="planCardSecond">
                                <div class="left" style="background-image: url(img/card_bg_2.png);">
                                    ...
                                    <div class="descr">
                                        ...
                                        <a href="register.php" class="btnFillColor2Md">Make deposit</a>
                                    </div>
                                </div>
                                <ul class="info">
                                    <li>Min Deposit <span>200 USD</span></li>
                                    <li>Max Deposit <span>499 USD</span></li>
                                </ul>
...
{/* 
                        <div class="item col6">
                            <div class="planCardFirst">
                                ...
                                <ul class="info">
                                    <li>Min Deposit <span>500 USD</span></li>
                                    <li>Max Deposit <span>999 USD</span></li>
                                </ul>
                        ...
                        {/* <div class="item col6">
                            <div class="planCardSecond">
                                ...
                                <ul class="info">
                                    <li>Min Deposit <span>1,000 USD</span></li>
                                    <li>Max Deposit <span>4,999 USD</span></li>
                                </ul>
                    ...
                    <div class="row">
                        ...
                        {/* <div class="item col6">
                            <div class="planCardFirst">
                                ...
                                <ul class="info">
                                    <li>Min Deposit <span>5,000 USD</span></li>
                                    <li>Max Deposit <span>9,999 USD</span></li>
                                </ul>
                                <img src="img/E.png" style="width: 80%; margin-top: 20px;" />
                        ...
                        <div class="item col6">
                            <div class="planCardSecond">
                                ...
                                <ul class="info">
                                    <li>Min Deposit <span>10,000 USD</span></li>
                                    <li>Max Deposit <span>UNLIMITED USD</span></li>
                                </ul>
                ...
                {/* <div class="container" style="margin-top: 40px; margin-bottom: 40px; ">
                    ...
                    <div class="textBlock">
                        ...
                        <p>
                            There are several other trading programs in the global market and each one competes with the
                            other in advertising. With Robot Trading, we put our money where our mouths are and focus on
                            ensuring success for the long-term investment relationship with our clients. We are
                            dedicated to our clients ‘ financial goals and objectives and so we have hundreds of them
                            over the span of only a few years. Our program is failure-free, user friendly, and easy to
                            install and operate.
                        </p>
                        <p>
                            As mentioned, our prime objective is to build profitable relationships and gain the trust of
                            our valued clients through superior performance and top-notch customer support. We’ll do all
                            we can at our disposal to see our clients grow with us and will prove to be one step ahead
                            of their expectations at all times.
                        </p>
                        <p>
                            - An innovative hybrid proof-of-work.<br />
                            - Proof-of-stake (PoS) consensus trading system.<br />
                            - Instant, on-demand cash-out.<br />
                        </p>
                    </div>
                ...
                <form onsubmit="return calc()">
                    ...
                    <div class="formBlockLight">
                        ...
                        <select name="choosePlan" id="calc_plan">
                            <option value="1" data-min="50" data-max="199" data-perc="110" data-per="1" checked>10%
                                After 48 hours</option>
                            <option value="2" data-min="200" data-max="499" data-perc="120" data-per="1">20% after 4
                                work Days </option>
                            <option value="3" data-min="500" data-max="999" data-perc="130" data-per="1">30% after 6
                                work Days </option>
                            <option value="4" data-min="1000" data-max="4999" data-perc="140" data-per="1">40% after 8
                                work Days</option>
                            <option value="3" data-min="5000" data-max="9999" data-perc="160" data-per="1">60% after 10
                                work Days </option>
                            <option value="4" data-min="10000" data-max="100000000" data-perc="180" data-per="1">80%
                                after 12 work Days </option>
                        </select>
                    </div>
                    <div class="sum">
    ...
    <div class="program gradBack">
        <div class="container">
            ...
            <div class="textBlock">
                <p>We appreciates the active partners that help us develop and advance our company. As a thank you for
                    each newly invited participant in this project, we charge referral commissions to their sponsors. In
                    addition, if your invitees will also develop our company, you will also get even more bonuses for
                    it!</p>
            </div>
            <a href="about.php" class="btnFillGradLg center">Learn More</a>

            <div class="cfix">
                <div class="statistic" style="display: none;">
                    <div class="row">
                        <div class="item">
                            <div class="img"><span class="icon-date"></span></div>
                        ...
                        <div class="item">
                            ...
                            <span class="num" style="font-size: 25px">$ 9,428,235.00</span>
                        </div>
                        <div class="item">
                            <div class="img">
                            ...
                            <span class="num" style="font-size: 25px">$ 1,062,095.00</span>
                        </div>
                        <div class="item">
                            <div class="img">
                ...
                <div class="grid">
                    <div class="item col4">
                        <div class="in">
                            ...
                            <p>No financial advisor? No experience trading cryptocurrency? No worries. Our algorithm
                                takes away the guesswork and executes transactions automatically on your behalf.</p>
                        </div>
                    </div>
                    <div class="item col4">
                        <div class="in">
                            ...
                            <p>Emotions and stress have a negative impact on trading. Our Automated platform allows you
                                to avoid that and gets the best option by analysing all data storage.</p>
                        </div>
                    </div>
                    <div class="item col4">
                        <div class="in">
                            <span class="icon-team gradTxt"></span>
                            <span class="title">NO MORE MIDDLE MEN</span>
                            <p>
                                Immediate funding without third-parties. Smart contracts autonomously perform funding –
                                collect and release payments.
                            </p>
                        </div>
                    </div>
                    <div class="item col4">
                        <div class="in">
                            ...
                            <span class="title">PROTECTION FROM HACKING</span>
                            <p>On a decentralized platform, all user accounts are independent; if one account is hacked,
                                this won’t breach the security.</p>
                        </div>
                    </div>
                    <div class="item col4">
                        <div class="in">
                            ...
                            <p>Robot Trading under the direction of Next Generation Technology Co., LTD is located in
                                United Kingdom and is governed by the laws of United Kingdom.</p>
                        </div>
                    </div>
                    <div class="item col4">
                        <div class="in">
                            ...
                            <p>Our platform is always available to ensure that no market opportunity is lost. Let our
                                platform work for you!</p>
                        </div>
                    </div>
                </div>
            </div>
